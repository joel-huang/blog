...
- Small object detection has a hard failure cliff driven by architecture, not training effort
- Below ~10-15 pixels, recall collapses across modern detectors regardless of model size
- Feature pyramid downsampling destroys spatial signal for tiny objects early
- You must make object size an explicit design constraint and plan for it
