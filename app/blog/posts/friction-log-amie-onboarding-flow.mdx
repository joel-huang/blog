...
Given my recent endeavor to meaningful explore the space of productivity systems + recommendations online and from friends, I attempted to give Amie a go.
...
The right-most column hints at their AI scheduling feature, and that that Amie respects your existing commitments.

<div style={{display: "flex", justifyContent: "center", padding: 20}}>
  <Image src="/blog/friction-log-amie-onboarding-flow/connect-calendars.jpg" width="400" height="100" />
</div>

I didn't notice it immediately, but the colors displayed matched my colors on Google Calendar. But the moment of delight only came when I realized afterwards, so there might be a better way to get users to make an immediate connection.
...
Integrations for work productivity are clearly marked Pro, but for poor me who clicked *Personal Use*, it comes across slightly irrelevant.
...
If you scroll back up to read my thoughts when I was answering the questionnaire, I was thinking that it'd set up some kind of payoff here, like using all the info I provided over the course of the onboarding to make Personal an irresistable offer, with an upsell opportunity for Pro.
...
Overall, Amie's design was pleasant to look at and I had small moments of delight throughout the flow (but I was also searching real hard for them).
